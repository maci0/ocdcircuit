...
def main() -> None:
    ...
    for c in comps:
        ...
        x, y = float(pos[0]) / MIL, float(pos[1]) / MIL
        L.append(f"fix {c['ref']} at {x:.2f} {y:.2f}")
        n_fix += 1
